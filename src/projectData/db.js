export  const data = [
...

  {
    ...
    "/img/buzy.mp4",
    title: "Buzynet-site",
    Text: "Welcome to the Tour Website In this project,  In this project, we'll create a minimalist and stylish Buzynet Website using the power of HTML, CSS, JavaScript. and bootsrap ",
  ...
  },
    {
      ...
      "/img/tour.mp4",
      title: "Tour Website ",
      Text: "Welcome to the Tour Website In this project,  In this project, we'll create a minimalist and stylish Tour Website using the power of HTML, CSS, JavaScript. and bootsrap ",
